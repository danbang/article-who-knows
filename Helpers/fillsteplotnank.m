function h = fillsteplotnank(dat,linewid,linez,condnames,xrange,colorcycle)
...
if nargin<6
colorcycle={'k','b','g','c','m','y','k','b','g','r','c','m','y','k'};
end
...
%    md = nanmean(d);
    fill_around_line(m,sd./sqrt(n),colorcycle{1});
end
